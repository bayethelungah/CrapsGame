 ...
 */
 ...
 public class Craps extends JFrame
 {
     ...
     private void buildFourthScene()
     {
         ...
         fourthSceneInfo.setLayout(new FlowLayout());
         ...
         int shooterIndex = (int) (Math.random() * currentGame.getPlayerList().size());
         currentGame.getPlayerList().get(shooterIndex).setIsShooter(true);
         ...
         {
             players.get(shooterIndex).setAmountBet(Integer.parseInt(betTexts[shooterIndex].getText()));
